...
const WHATSAPP = '0960249009'
const WHATSAPP_LINK = `https://wa.me/593${WHATSAPP.slice(1)}`
const INSTAGRAM = 'honeygirl_ec'
const TIKTOK = 'honeygirlec'
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white border border-stone-200 flex items-center justify-center text-stone-500 hover:text-[#25D366] hover:border-[#25D366] transition-all" title="WhatsApp">
              <IconWhatsApp />
            </a>
            <a href={`https://instagram.com/${INSTAGRAM}`} target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white border border-stone-200 flex items-center justify-center text-stone-500 hover:text-[#E1306C] hover:border-[#E1306C] transition-all" title="Instagram">
              <IconInstagram />
            </a>
            <a href={`https://tiktok.com/@${TIKTOK}`} target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white border border-stone-200 flex items-center justify-center text-stone-500 hover:text-stone-900 hover:border-stone-900 transition-all" title="TikTok">
              <IconTikTok />
            </a>
          </div>
        </div>
